...
"""
    Python module for Firebase Geo Queries.
    for more info visit https://github.com/vinsci/geohash
    How to use:

    print 'Geohash for 42.6, -5.6:', Geohash.encode(42.6, -5.6)
    print 'Geohash for 42.6, -5.6:', Geohash.encode(42.6, -5.6, precision=12)
